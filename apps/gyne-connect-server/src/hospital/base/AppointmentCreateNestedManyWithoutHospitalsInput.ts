...
@InputType()
class AppointmentCreateNestedManyWithoutHospitalsInput {
...
export { AppointmentCreateNestedManyWithoutHospitalsInput as AppointmentCreateNestedManyWithoutHospitalsInput };
